...
| S02 | Browse | the full corpus renders as table rows | ✅ PASS | 6318 figure rows |
| S03 | Search / filter | typing in search narrows the table; clearing restores it | ✅ PASS | full=6318, "thor"→15, restored=6318 |
...
| S18 | Items registry | the Items view lists the object corpus grouped by kind | ✅ PASS | 3197 item rows, grouped |
...
| S22 | Persistence — corruption | corrupted localStorage JSON falls back to the seed | ✅ PASS | fell back to seed (6318 rows), no errors |
...
| S30 | Browse — tradition filter | selecting a tradition in the rail narrows the table | ✅ PASS | Norse filter: 6318 → 101 → 6318 |
