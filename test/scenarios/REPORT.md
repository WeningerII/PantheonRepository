...
| S02 | Browse | the full corpus renders as table rows | ✅ PASS | 7203 figure rows |
| S03 | Search / filter | typing in search narrows the table; clearing restores it | ✅ PASS | full=7203, "thor"→18, restored=7203 |
...
| S18 | Items registry | the Items view lists the object corpus grouped by kind | ✅ PASS | 3215 item rows, grouped |
...
| S22 | Persistence — corruption | corrupted localStorage JSON falls back to the seed | ✅ PASS | fell back to seed (7203 rows), no errors |
...
| S30 | Browse — tradition filter | selecting a tradition in the rail narrows the table | ✅ PASS | Norse filter: 7203 → 101 → 7203 |
