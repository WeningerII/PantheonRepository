...
| S02 | Browse | the full corpus renders as table rows | ✅ PASS | 2067 figure rows |
| S03 | Search / filter | typing in search narrows the table; clearing restores it | ✅ PASS | full=2067, "thor"→6, restored=2067 |
...
| S18 | Items registry | the Items view lists the object corpus grouped by kind | ✅ PASS | 1427 item rows, grouped |
...
| S22 | Persistence — corruption | corrupted localStorage JSON falls back to the seed | ✅ PASS | fell back to seed (2067 rows), no errors |
...
| S30 | Browse — tradition filter | selecting a tradition in the rail narrows the table | ✅ PASS | Norse filter: 2067 → 41 → 2067 |
...
| S34 | Detail — figure nav | Prev/Next step through the filtered list and return | ✅ PASS | Prev/Next: "'Antara ibn Shaddad" ↔ "Aatxe" |
