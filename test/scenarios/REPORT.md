...
| S02 | Browse | the full corpus renders as table rows | ✅ PASS | 6818 figure rows |
| S03 | Search / filter | typing in search narrows the table; clearing restores it | ✅ PASS | full=6818, "thor"→18, restored=6818 |
...
| S22 | Persistence — corruption | corrupted localStorage JSON falls back to the seed | ✅ PASS | fell back to seed (6818 rows), no errors |
...
| S30 | Browse — tradition filter | selecting a tradition in the rail narrows the table | ✅ PASS | Norse filter: 6818 → 101 → 6818 |
