...
| S02 | Browse | the full corpus renders as table rows | ✅ PASS | 6906 figure rows |
| S03 | Search / filter | typing in search narrows the table; clearing restores it | ✅ PASS | full=6906, "thor"→18, restored=6906 |
...
| S18 | Items registry | the Items view lists the object corpus grouped by kind | ✅ PASS | 3211 item rows, grouped |
...
| S22 | Persistence — corruption | corrupted localStorage JSON falls back to the seed | ✅ PASS | fell back to seed (6906 rows), no errors |
...
| S30 | Browse — tradition filter | selecting a tradition in the rail narrows the table | ✅ PASS | Norse filter: 6906 → 101 → 6906 |
