...
| S02 | Browse | the full corpus renders as table rows | ✅ PASS | 6934 figure rows |
| S03 | Search / filter | typing in search narrows the table; clearing restores it | ✅ PASS | full=6934, "thor"→18, restored=6934 |
...
| S18 | Items registry | the Items view lists the object corpus grouped by kind | ✅ PASS | 3212 item rows, grouped |
...
| S22 | Persistence — corruption | corrupted localStorage JSON falls back to the seed | ✅ PASS | fell back to seed (6934 rows), no errors |
...
| S30 | Browse — tradition filter | selecting a tradition in the rail narrows the table | ✅ PASS | Norse filter: 6934 → 101 → 6934 |
