...
| S02 | Browse | the full corpus renders as table rows | ✅ PASS | 4014 figure rows |
| S03 | Search / filter | typing in search narrows the table; clearing restores it | ✅ PASS | full=4014, "thor"→9, restored=4014 |
...
| S18 | Items registry | the Items view lists the object corpus grouped by kind | ✅ PASS | 2687 item rows, grouped |
...
| S22 | Persistence — corruption | corrupted localStorage JSON falls back to the seed | ✅ PASS | fell back to seed (4014 rows), no errors |
...
| S30 | Browse — tradition filter | selecting a tradition in the rail narrows the table | ✅ PASS | Norse filter: 4014 → 67 → 4014 |
