...
| S02 | Browse | the full corpus renders as table rows | ✅ PASS | 2792 figure rows |
| S03 | Search / filter | typing in search narrows the table; clearing restores it | ✅ PASS | full=2792, "thor"→6, restored=2792 |
...
| S15 | Atlas view | the atlas mounts all mapped territories | ✅ PASS | 332 paths, 239 traditions |
...
| S22 | Persistence — corruption | corrupted localStorage JSON falls back to the seed | ✅ PASS | fell back to seed (2792 rows), no errors |
...
| S30 | Browse — tradition filter | selecting a tradition in the rail narrows the table | ✅ PASS | Norse filter: 2792 → 67 → 2792 |
