...
| S02 | Browse | the full corpus renders as table rows | ✅ PASS | 2846 figure rows |
| S03 | Search / filter | typing in search narrows the table; clearing restores it | ✅ PASS | full=2846, "thor"→6, restored=2846 |
...
| S18 | Items registry | the Items view lists the object corpus grouped by kind | ✅ PASS | 2119 item rows, grouped |
...
| S22 | Persistence — corruption | corrupted localStorage JSON falls back to the seed | ✅ PASS | fell back to seed (2846 rows), no errors |
...
| S30 | Browse — tradition filter | selecting a tradition in the rail narrows the table | ✅ PASS | Norse filter: 2846 → 67 → 2846 |
